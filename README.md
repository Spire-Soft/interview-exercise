...
## Overview
This exercise consists of building a **Minimal API Backend** using .NET and a **Frontend** with a component-based architecture. The goal is to focus on **quality, reusability, and scalability** rather than just finishing the tasks.
